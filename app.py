...
st.image("https://raw.githubusercontent.com/andreslira-app/sistema-sanciones-manquemavida/refs/heads/main/insignia.png") st.title("⚖️ Colegio Manquemávida Sistema de Sugerencia de Sanciones")
