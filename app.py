...
reglamento = [
    ...
    ("chatntaj", "Amedrentar, amenazar, chantajear, intimidar, hostigar, acosar, difamar o burlarse de un estudiante u otro miembro de la comunidad educativa (por ejemplo, utilizar sobrenombres hirientes, mofarse de características físicas, etc.). ", "Art. 292 Numeral 4: Suspensión o expulsión", "Gravísima"),
